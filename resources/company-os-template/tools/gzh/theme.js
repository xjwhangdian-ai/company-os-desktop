...
const T = {
  ...
  // 文末品牌签名卡
  footer: `<section style="margin:38px 0 10px;padding:22px 20px;background:${NAVY};border-radius:12px;text-align:center;">`+
    `<p style="margin:0 0 4px;font-size:20px;font-weight:bold;color:#fff;letter-spacing:2px;">炬视 · JUSHI TECH</p>`+
    `<p style="margin:0 0 10px;font-size:13px;color:${LTEAL};letter-spacing:1.5px;">具身智能 · 视检万物</p>`+
    `<p style="margin:0;font-size:14px;color:#cdd6e0;line-height:1.7;">台州炬视科技有限公司 · 知世界 行天下<br/>天空地（水）一体化无人装备协同智能平台</p>`+
    `</section>`,
};
